...
const AkaConsultingWebsite = () => {
  return (
    <div className="font-sans bg-aka-beige">
      <div className="bg-aka-blue-gray">
        <header className="max-w-7xl mx-auto px-4 flex justify-between items-center h-20">
          <AkaLogo />
      ...
      <main>
        <div className="bg-aka-light-brown">
          <section className="max-w-7xl mx-auto px-4 py-12 text-aka-dark-brown">
            <div className="flex flex-col items-start mb-6">
              <img src={kittenLogo} alt="Kitten Logo" className="w-48 h-48 object-contain mb-4" />
        ...
        <div className="bg-aka-dark-brown">
          <section className="max-w-7xl mx-auto px-4 py-8 text-aka-beige">
            <p className="text-lg mb-4">Trusted by these brands and organizations:</p>
        ...
        <section className="py-12 bg-aka-beige">
        ...
        <section className="bg-aka-light-brown py-12">
      ...
      <footer className="bg-aka-dark-brown text-aka-beige">
